...
public class AdminStorageController {
  ...
  @Autowired private LitemallStorageService litemallStorageService;
  ...
  public Object list(
    ...
    List<LitemallStorage> storageList =
        litemallStorageService.querySelective(key, name, page, limit, sort, order);
