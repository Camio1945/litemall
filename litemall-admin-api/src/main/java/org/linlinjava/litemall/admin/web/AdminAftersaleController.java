...
public class AdminAftersaleController {
  ...
  public Object list(
    ...
    List<LitemallAftersale> aftersaleList =
        aftersaleService.querySelective(orderId, aftersaleSn, status, page, limit, sort, order);
  ...
  public Object refund(@RequestBody LitemallAftersale aftersale) {
    ...
    logHelper.logOrderSucceed(
        "退款", "订单编号 " + order.getOrderSn() + " 售后编号 " + aftersale.getAftersaleSn());
    return ResponseUtil.ok();
  }
}
