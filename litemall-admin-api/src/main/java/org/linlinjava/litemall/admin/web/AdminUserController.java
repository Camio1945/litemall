...
public class AdminUserController {
  ...
  public Object list(
    ...
    List<LitemallUser> userList =
        userService.querySelective(username, mobile, page, limit, sort, order);
  ...
  public Object initTestData() {
    UnaryOperator<String> encryptPassword = (password) -> {
      BCryptPasswordEncoder encoder = new BCryptPasswordEncoder();
      return encoder.encode(password);
    };
    return ResponseUtil.ok(userService.initTestData(encryptPassword));
  }
}
