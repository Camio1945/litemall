...
public class AdminKeywordController {
  ...
  @Autowired private LitemallKeywordService keywordService;
  ...
  public Object list(
    ...
    List<LitemallKeyword> keywordList =
        keywordService.querySelective(keyword, url, page, limit, sort, order);
