...
public interface LitemallOrderMapper {
   ...
   * @mbg.generated
   */
  LitemallOrder selectOneByExampleSelective(
      @Param("example") LitemallOrderExample example,
   ...
   * @mbg.generated
   */
  List<LitemallOrder> selectByExampleSelective(
      @Param("example") LitemallOrderExample example,
      @Param("selective") LitemallOrder.Column... selective);
   ...
   * @mbg.generated
   */
  LitemallOrder selectByPrimaryKeySelective(
      @Param("id") Integer id, @Param("selective") LitemallOrder.Column... selective);
   ...
   * @mbg.generated
   */
  LitemallOrder selectByPrimaryKeyWithLogicalDelete(
  ...
  int updateByExampleSelective(
      @Param("record") LitemallOrder record, @Param("example") LitemallOrderExample example);
