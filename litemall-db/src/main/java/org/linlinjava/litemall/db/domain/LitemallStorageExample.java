...
public class LitemallStorageExample {
  ...
  protected abstract static class GeneratedCriteria {
    ...
    public Criteria andSizeNotEqualToColumn(LitemallStorage.Column column) {
      addCriterion(
          new StringBuilder("`size` <> ").append(column.getEscapedColumnName()).toString());
      return (Criteria) this;
    }
  ...
  public static class Criteria extends GeneratedCriteria {
    ...
    public Criteria andLogicalDeleted(boolean deleted) {
      return deleted
          ? andDeletedEqualTo(LitemallStorage.Deleted.IS_DELETED.value())
          : andDeletedNotEqualTo(LitemallStorage.Deleted.IS_DELETED.value());
    }
