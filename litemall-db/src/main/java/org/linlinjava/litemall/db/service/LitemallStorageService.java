...
public class LitemallStorageService {
  @Autowired private LitemallStorageMapper storageMapper;
  ...
  public List<LitemallStorage> querySelective(
      String key, String name, Integer page, Integer limit, String sort, String order) {
    LitemallStorageExample example = new LitemallStorageExample();
