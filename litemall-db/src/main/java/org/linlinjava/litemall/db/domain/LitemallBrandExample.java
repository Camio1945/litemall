...
public class LitemallBrandExample {
  ...
  protected abstract static class GeneratedCriteria {
    ...
    public Criteria andFloorPriceEqualToColumn(LitemallBrand.Column column) {
      addCriterion(
          new StringBuilder("floor_price = ").append(column.getEscapedColumnName()).toString());
      return (Criteria) this;
    }
  ...
  public static class Criteria extends GeneratedCriteria {
    ...
    public Criteria andLogicalDeleted(boolean deleted) {
      return deleted
          ? andDeletedEqualTo(LitemallBrand.Deleted.IS_DELETED.value())
          : andDeletedNotEqualTo(LitemallBrand.Deleted.IS_DELETED.value());
    }
