...
public interface LitemallNoticeMapper {
   ...
   * @mbg.generated
   */
  LitemallNotice selectOneByExampleSelective(
      @Param("example") LitemallNoticeExample example,
      @Param("selective") LitemallNotice.Column... selective);
   ...
   * @mbg.generated
   */
  List<LitemallNotice> selectByExampleSelective(
      @Param("example") LitemallNoticeExample example,
      @Param("selective") LitemallNotice.Column... selective);
   ...
   * @mbg.generated
   */
  LitemallNotice selectByPrimaryKeySelective(
      @Param("id") Integer id, @Param("selective") LitemallNotice.Column... selective);
   ...
   * @mbg.generated
   */
  LitemallNotice selectByPrimaryKeyWithLogicalDelete(
  ...
  int updateByExampleSelective(
      @Param("record") LitemallNotice record, @Param("example") LitemallNoticeExample example);
