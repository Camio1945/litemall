...
public interface LitemallCartMapper {
   ...
   * @mbg.generated
   */
  LitemallCart selectOneByExampleSelective(
      @Param("example") LitemallCartExample example,
      @Param("selective") LitemallCart.Column... selective);
   ...
   * @mbg.generated
   */
  List<LitemallCart> selectByExampleSelective(
      @Param("example") LitemallCartExample example,
      @Param("selective") LitemallCart.Column... selective);
   ...
   * @mbg.generated
   */
  LitemallCart selectByPrimaryKeySelective(
      @Param("id") Integer id, @Param("selective") LitemallCart.Column... selective);
   ...
   * @mbg.generated
   */
  LitemallCart selectByPrimaryKeyWithLogicalDelete(
  ...
  int updateByExampleSelective(
      @Param("record") LitemallCart record, @Param("example") LitemallCartExample example);
