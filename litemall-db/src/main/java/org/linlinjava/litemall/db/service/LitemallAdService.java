...
public class LitemallAdService {
  @Resource private LitemallAdMapper adMapper;
  ...
  public List<LitemallAd> querySelective(
      String name, String content, Integer page, Integer limit, String sort, String order) {
    LitemallAdExample example = new LitemallAdExample();
