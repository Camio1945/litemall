...
public class LitemallCouponService {
  @Resource private LitemallCouponMapper couponMapper;
  ...
  public List<LitemallCoupon> queryAvailableList(Integer userId, int offset, int limit) {
    ...
    List<LitemallCouponUser> used =
        couponUserMapper.selectByExample(
   ...
   * @return
   */
  public List<LitemallCoupon> queryList(
      LitemallCouponExample.Criteria criteria, int offset, int limit, String sort, String order) {
    criteria
  ...
  public List<LitemallCoupon> querySelective(
      String name,
      Short type,
      Short status,
      Integer page,
