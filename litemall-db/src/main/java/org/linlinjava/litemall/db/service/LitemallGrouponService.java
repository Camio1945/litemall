...
public class LitemallGrouponService {
  @Resource private LitemallGrouponMapper mapper;
  ...
  public List<LitemallGroupon> queryMyGroupon(Integer userId) {
    ...
    example
        ...
        .andCreatorUserIdEqualTo(userId)
        .andGrouponIdEqualTo(0)
   ...
   * @return
   */
  public List<LitemallGroupon> querySelective(
      String rulesId, Integer page, Integer size, String sort, String order) {
    LitemallGrouponExample example = new LitemallGrouponExample();
