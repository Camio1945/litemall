...
public class LitemallNoticeService {
  @Resource private LitemallNoticeMapper noticeMapper;

  public List<LitemallNotice> querySelective(
      String title, String content, Integer page, Integer limit, String sort, String order) {
