...
public class LitemallTopicService {
  @Resource private LitemallTopicMapper topicMapper;
  ...
  public List<LitemallTopic> querySelective(
      String title, String subtitle, Integer page, Integer limit, String sort, String order) {
    LitemallTopicExample example = new LitemallTopicExample();
