...
public interface LitemallOrderGoodsMapper {
   ...
   * @mbg.generated
   */
  LitemallOrderGoods selectOneByExampleSelective(
   ...
   * @mbg.generated
   */
  List<LitemallOrderGoods> selectByExampleSelective(
      @Param("example") LitemallOrderGoodsExample example,
      @Param("selective") LitemallOrderGoods.Column... selective);
   ...
   * @mbg.generated
   */
  LitemallOrderGoods selectByPrimaryKeySelective(
      @Param("id") Integer id, @Param("selective") LitemallOrderGoods.Column... selective);
   ...
   * @mbg.generated
   */
  LitemallOrderGoods selectByPrimaryKeyWithLogicalDelete(
  ...
  int updateByExampleSelective(
      @Param("record") LitemallOrderGoods record,
      @Param("example") LitemallOrderGoodsExample example);
