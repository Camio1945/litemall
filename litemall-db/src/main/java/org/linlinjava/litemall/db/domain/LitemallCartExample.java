...
public class LitemallCartExample {
  ...
  protected abstract static class GeneratedCriteria {
    ...
    public Criteria andCheckedEqualToColumn(LitemallCart.Column column) {
      addCriterion(
          new StringBuilder("`checked` = ").append(column.getEscapedColumnName()).toString());
      return (Criteria) this;
    }
  ...
  public static class Criteria extends GeneratedCriteria {
    ...
    public Criteria andLogicalDeleted(boolean deleted) {
      return deleted
          ? andDeletedEqualTo(LitemallCart.Deleted.IS_DELETED.value())
          : andDeletedNotEqualTo(LitemallCart.Deleted.IS_DELETED.value());
    }
