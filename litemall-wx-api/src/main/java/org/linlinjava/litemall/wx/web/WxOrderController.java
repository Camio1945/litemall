...
public class WxOrderController {
  ...
  public Object prepay(
      @LoginUser Integer userId, @RequestBody String body, HttpServletRequest request) {
   ...
   * 微信付款成功或失败回调接口
   *
   * <p>TODO 注意，这里pay-notify是示例地址，建议开发者应该设立一个隐蔽的回调地址
   *
   * @param request 请求内容
   * @param response 响应内容
   * @return 操作结果
   ...
   */
  @GetMapping("goods")
  public Object goods(@LoginUser Integer userId, @NotNull Integer ogid) {
