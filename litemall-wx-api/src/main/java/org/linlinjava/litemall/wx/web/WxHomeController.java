...
public class WxHomeController {
  ...
  @Autowired private WxGrouponRuleService grouponService;
  ...
  public Object index(@LoginUser Integer userId) {
    ...
    Callable<List> topicListCallable =
        () -> topicService.queryList(0, SystemConfig.getTopicLimit());
  ...
  private List<Map> getCategoryList() {
    ...
    List<LitemallCategory> catL1List =
        categoryService.queryL1WithoutRecommend(0, SystemConfig.getCatlogListLimit());
