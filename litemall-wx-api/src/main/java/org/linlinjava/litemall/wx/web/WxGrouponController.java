...
public class WxGrouponController {
  ...
  @Autowired private WxGrouponRuleService wxGrouponRuleService;
  ...
  public Object list(
    ...
    List<GrouponRuleVo> grouponRuleVoList =
        wxGrouponRuleService.queryList(page, limit, sort, order);
